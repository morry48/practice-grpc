...
func main() {
	certFile := "/Users/moriguchiyu/Library/Application Support/mkcert/rootCA.pem"
...
func callDownload(client pb.FileServiceClient) {
	...
	for {
		...
		log.Printf("response form Download(string): %v", string(res.GetData()))
	}
}
